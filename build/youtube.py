...
def parse_args():
    parser = argparse.ArgumentParser(description='prepare PS YouTube dataset')
    parser.add_argument('--download_dir', type=str, default='datasets/youtube')
    parser.add_argument('--src_dir', type=str, default='datasets/youtube/videos')
    parser.add_argument('--out_dir', type=str, default='datasets/youtube/rawframes')
    parser.add_argument('--frame_path', type=str, default='datasets/youtube/rawframes')
    parser.add_argument('--anno_dir', type=str, default='datasets/youtube/testTrain_splits')
    parser.add_argument('--out_list_path', type=str, default='datasets/youtube/testTrain_splits')
...
#    if args.download:
#        print('Downloading PS YouTube dataset.')
